...
(library Library_1
	...
	(patternDef "HC/49US_(AT49)PTH" (originalName "HC/49US_(AT49)PTH")
		...
		(layerContents (layerNumRef 28)
			(arc (pt -3.35112, 0) (radius 2.53162) (startAngle 99.1) (sweepAngle 161.9) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(arc (pt 3.35112, 0) (radius 2.53162) (startAngle 80.9) (sweepAngle -161.9) (width 0.025))
		)
		(layerContents (layerNumRef 18)
