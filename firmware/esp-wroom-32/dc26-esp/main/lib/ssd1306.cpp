...
//
/////////////////////////////////////////////////////////////////////////////////////////////////////////
static ESP32_I2CMaster *I2CDisplay = 0;
...
bool ssd1306_I2C_Init( ESP32_I2CMaster *i2c) {
	if(!i2c->init() || !i2c->start(SSD1306_I2C_ADDR,true) || !i2c->stop(1000)) {
		return false;
	}
	I2CDisplay=i2c;
	return true;
...
void SSD1306_UpdateScreen(void) {
	...
	for (m = 0; m < 8; m++) {
		...
		/* Write multi data */
		ssd1306_I2C_WriteMulti(0x40, &SSD1306_Buffer[SSD1306_WIDTH * m], SSD1306_WIDTH + 1);
	}
}
